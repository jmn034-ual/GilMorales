...
//		this.ver_perfil = new Ver_perfil_publico(publicacion.getPerteneceA());
		this.ver_perfil = new Ver_perfil_publico(unr, this.publicacion.getPerteneceA());
	...
	public void Ver_comentarios__Usuario_No_registrado_() {
		verComentariosUNR = new Ver_comentarios__Usuario_No_registrado_(this.publicacion, unr);
