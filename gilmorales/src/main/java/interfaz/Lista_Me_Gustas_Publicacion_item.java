...
public class Lista_Me_Gustas_Publicacion_item extends VistaListaMeGustasPublicacionItem{
	...
	public void Ver_perfil() {
		this.getBotonNombreUsuario().addClickListener(event -> {
			this.ver_perfil = new Ver_perfil_publico(this.user, this, this._lista_Me_Gustas_Publicacion._ver_me_gustas_publicacion._ver_publicacion_propia.urInterfaz._cabecera_Usuario_Registrado._cabecera_TOP);
			this._lista_Me_Gustas_Publicacion._ver_me_gustas_publicacion._ver_publicacion_propia.getVaadinHorizontalLayout().removeAll();
			this._lista_Me_Gustas_Publicacion._ver_me_gustas_publicacion._ver_publicacion_propia.getVaadinHorizontalLayout().add(this.ver_perfil);
