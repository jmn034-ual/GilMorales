...
public class VistaVerPublicacionAdministrador extends LitTemplate {
	...
	public void setLayoutNumVisualizaciones(HorizontalLayout layoutNumVisualizaciones) {
		this.layoutNumVisualizaciones = layoutNumVisualizaciones;
	}
	...
	public Button getEliminarPublicacion() {
		return eliminarPublicacion;
	}



	public void setEliminarPublicacion(Button eliminarPublicacion) {
		this.eliminarPublicacion = eliminarPublicacion;
	}
