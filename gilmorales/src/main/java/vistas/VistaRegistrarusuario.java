...
public class VistaRegistrarusuario extends LitTemplate {
	...
	private Element vaadinVerticalLayout;
		...
		@Id("nombreDeUsuarioTF")
		private TextField nombreDeUsuarioTF;
		...
		public void setApellifosTF(TextField apellifosTF) {
			this.apellifosTF = apellifosTF;
		}
		...
		public void setConfirmarTF(TextField confirmarTF) {
		...
		public void setNombreDeUsuarioTF(TextField nombreDeUsuarioTF) {
			this.nombreDeUsuarioTF = nombreDeUsuarioTF;
		}
		...
		public void setNormal(Checkbox normal) {
			this.normal = normal;
		}
		...
		public void setComercial(Checkbox comercial) {
		...
		public void setSubirFoto(Button subirFoto) {
		...
		public void setDescartar(Button descartar) {
