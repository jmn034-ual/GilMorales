...
public class GilMoralesPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "GilMorales";
	...
	private GilMoralesPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(bd_dcl.Publicacion.class);
		aMetadataSources.addAnnotatedClass(bd_dcl.UsuarioRegistrado.class);
		aMetadataSources.addAnnotatedClass(bd_dcl.UsuarioAdministrador.class);
		aMetadataSources.addAnnotatedClass(bd_dcl.Comentario.class);
		aMetadataSources.addAnnotatedClass(bd_dcl.Denuncia.class);
		aMetadataSources.addAnnotatedClass(bd_dcl.Notificacion.class);
		aMetadataSources.addAnnotatedClass(bd_dcl.Hashtag.class);
		aMetadataSources.addAnnotatedClass(bd_dcl.UsuarioComercial.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new GilMoralesPersistentManager();
		}
