...
export class VistaVerTendencias extends LitElement {
  ...
  render() {
    return html`
<vaadin-horizontal-layout id="vaadinHorizontalLayout" style="flex-shrink: 0; overflow-y: auto; height: 100%; scrollbar-width: thin; scrollbar-color: transparent transparent; width: 100%; margin: 0px;" theme="spacing-s">
 ...
 <vaadin-vertical-layout id="vaadinVerticalLayout1" style="flex-grow: 0; height: 100%; flex-shrink: 0; overflow-y: auto; scrollbar-width: thin; scrollbar-color: transparent transparent; padding-bottom: var(--lumo-space-xl); width: 88%;">
  <vaadin-horizontal-layout theme="spacing" id="vaadinHorizontalLayout1" style="flex-grow: 0; flex-shrink: 0; padding-top: 3%; width: 100%; justify-content: flex-start; align-self: stretch;">
   ...
   <vaadin-vertical-layout theme="spacing-xs" id="vaadinVerticalLayout2" style="justify-content: flex-start; align-items: flex-start; align-self: center;">
    ...
    <vaadin-horizontal-layout id="layoutDescripcion" style="align-self: flex-start; align-items: center; border-left: 2px solid black; border-top: none; border-right: none; border-bottom: none; padding-left: var(--lumo-space-m);">
     <label id="labelDescripcion" style="flex-grow: 0; flex-shrink: 0; align-self: center;">Descripción sobre el perfil del usuario.</label>
   ...
   <vaadin-vertical-layout id="vaadinVerticalLayout3" style="flex-grow: 1; flex-shrink: 0; align-items: flex-end; padding: 2px;">
  ...
  <vaadin-horizontal-layout theme="spacing" id="layoutDatosPerfil" style="align-items: center; margin-left: var(--lumo-space-s); margin-top: var(--lumo-space-xs);">
   <vaadin-horizontal-layout theme="spacing" style="border-left: none; border-top: none; border-right: 2px solid black; border-bottom: none; align-items: center; padding-right: var(--lumo-space-m);">
...
justify-content: center; align-items: center; height: 20px; justify-content: center; font-weight: bold;">0</label>
   ...
   <vaadin-horizontal-layout theme="spacing" style="border-left: none; border-top: none; border-right: 2px solid black; border-bottom: none; padding-right: var(--lumo-space-m); align-items: center;">
