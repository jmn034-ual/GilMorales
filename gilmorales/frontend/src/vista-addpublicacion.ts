...
<vaadin-vertical-layout theme="spacing" style="width: 100%; height: 100%;" id="vaadinVerticalLayout">
 <vaadin-horizontal-layout style="width: 100%;" id="cabecera"></vaadin-horizontal-layout>
 <vaadin-horizontal-layout theme="spacing-s" style="width: 100%; flex-shrink: 0; flex-grow: 1;" id="vaadinHorizontalLayout">
  <vaadin-vertical-layout style="flex-shrink: 1; flex-grow: 0; margin: var(--lumo-space-s); width: 70%;" id="layoutSubirVideo" theme="spacing-xs">
