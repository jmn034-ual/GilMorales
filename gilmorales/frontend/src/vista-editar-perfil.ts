...
export class VistaEditarPerfil extends LitElement {
  ...
  render() {
    return html`
<vaadin-vertical-layout style="width: 50%; height: 50%; background-color: #ffffff; z-index: 999; position: fixed; align-items: center; border-radius: 10px;" id="layoutEditarPerfil">
 ...
 <vaadin-vertical-layout theme="spacing" style="width: 100%; flex-shrink: 0; flex-grow: 1; height: 70%;">
  <vaadin-horizontal-layout theme="spacing" id="layoutFoto" style="width: 100%; flex-shrink: 0; margin-top: var(--lumo-space-l);">
  ...
  <vaadin-horizontal-layout theme="spacing" style="flex-shrink: 0; width: 100%; height: 30%; align-self: center;" id="vaadinHorizontalLayout3">
   ...
   <vaadin-text-area id="textAreaDescripcion" style="flex-shrink: 0;"></vaadin-text-area>
  </vaadin-horizontal-layout>
