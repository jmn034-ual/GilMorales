...
export class VistaEditarPerfil extends LitElement {
  ...
  render() {
    return html`
<vaadin-vertical-layout style="width: 50%; height: 60%; background-color: #ffffff; z-index: 999; margin-left: 25%; position: fixed; align-items: center; max-width: 50%;" id="layoutEditarPerfil" theme="spacing">
 ...
 <vaadin-vertical-layout theme="spacing" style="height: 100%; width: 100%; flex-shrink: 1;">
  ...
  <vaadin-horizontal-layout theme="spacing" style="flex-shrink: 0; width: 100%; height: 30%; align-self: center;" id="vaadinHorizontalLayout3">
   ...
   <vaadin-text-area id="textAreaDescripcion" style="height: 90%;"></vaadin-text-area>
  </vaadin-horizontal-layout>
