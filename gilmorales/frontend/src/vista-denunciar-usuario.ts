...
<vaadin-vertical-layout id="layoutDenunciarUsuario" style="flex-grow: 0; flex-shrink: 0; height: 100%; width: 100%;">
 ...
 <vaadin-vertical-layout id="vaadinVerticalLayout1" style="align-self: center; width: 70%; flex-grow: 1;">
  <vaadin-horizontal-layout theme="spacing" id="layoutNombre" style="align-self: stretch;">
   <h4 id="tituloNombre">Motivo:</h4>
   <vaadin-text-field label="" placeholder="Motivo de la denuncia..." id="textFieldNombreusuario" style="align-self: center; flex-grow: 1; margin: var(--lumo-space-m);"></vaadin-text-field>
  </vaadin-horizontal-layout>
