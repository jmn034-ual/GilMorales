...
<vaadin-vertical-layout style="width: 100%; height: 100%; position: fixed; padding: 0px; margin: 0px; flex-direction: column; display: flex; justify-content: flex-start;" id="vaadinVerticalLayout">
 ...
 <vaadin-horizontal-layout id="vaadinHorizontalLayout" style="flex-grow: 0; width: 100%; flex-shrink: 0; justify-content: flex-start; background-color: #ffffff; display: flex; overflow-y: auto; height: 100%;"></vaadin-horizontal-layout>
