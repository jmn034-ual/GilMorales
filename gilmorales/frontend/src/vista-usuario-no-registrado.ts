...
<vaadin-vertical-layout style="width: 100%; height: 100%; position: fixed; overflow-y: auto; padding: 0px; margin: 0px; flex-direction: column; display: flex; justify-content: flex-start;" id="vaadinVerticalLayout">
 ...
 <vaadin-horizontal-layout id="vaadinHorizontalLayout" style="flex-grow: 0; position:fixed; width: 100%; margin-top: 60px; flex-shrink: 0; justify-content: flex-start; background-color: #ffffff; display: flex; padding: 0px; height: 100%; padding-bottom: 3%;">
  ...
  <vaadin-vertical-layout theme="spacing" id="layoutListaPublicaciones" style="flex-grow: 0; align-items: center; flex-shrink: 0; overflow-y: auto; z-index: 999; scrollbar-width: thin; scrollbar-color: transparent transparent; width: 100%; padding-bottom: var(--lumo-space-xl);"></vaadin-vertical-layout>
