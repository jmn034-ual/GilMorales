...
export class VistaRealizarBusqueda extends LitElement {
  ...
  render() {
    return html`
<vaadin-vertical-layout id="layoutListaResultadoBusqueda" style="flex-grow: 1; flex-shrink: 0; overflow-y: auto; width: 100%; height: 100%; padding: 0px; overflow-x: hidden; align-items: center;">
 <vaadin-vertical-layout theme="spacing" style="width: 100%; height: 100%; align-self: center; align-items: center; margin-left: 5%;">
  ...
  <hr style="width: 95%;">
  <vaadin-horizontal-layout id="vaadinHorizontalLayout2" style="align-self: stretch; margin: var(--lumo-space-s);">
