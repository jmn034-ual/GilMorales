...
<vaadin-vertical-layout style="width: 100%; height: 100%; position: fixed; overflow-y: auto; padding: 0px; margin: 0px; flex-direction: column; display: flex; justify-content: flex-start;" id="vaadinVerticalLayout">
 ...
 <vaadin-horizontal-layout style="flex-grow: 1; position:fixed; width: 100%; margin-top: 60px; overflow: hidden; flex-shrink: 0; justify-content: flex-start; background-color: #ffffff; display: flex; padding: 0px; height: 100%;" id="vaadinHorizontalLayout">
