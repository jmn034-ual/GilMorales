...
<vaadin-vertical-layout style="width: 100%; height: 100%; position: fixed; overflow-y: auto; padding: 0px; margin: 0px; flex-direction: column; display: flex; justify-content: flex-start;" id="vaadinVerticalLayout">
 ...
 <vaadin-horizontal-layout style="flex-grow: 1; position:fixed; width: 100%; margin-top: 60px;  flex-shrink: 0; justify-content: flex-start; background-color: #ffffff; display: flex; padding: 0px; height: 100%; overflow-y: auto;" id="vaadinHorizontalLayout">
  <vaadin-vertical-layout id="cabeceraTop" style="height: 110%; flex-shrink: 0; margin: 0%; max-width: 190px; z-index: 999; background-color: #C8C4C4; flex-grow: 0; width: 190px;"></vaadin-vertical-layout>
