...
<vaadin-vertical-layout theme="spacing" id="vaadinVerticalLayout" style="width: 100%; height: 100%; min-height: 100%; min-width: 100%;">
 <vaadin-horizontal-layout theme="spacing-xs" id="vaadinHorizontalLayout3" style="height: 100%; width: 100%; padding: 10px; min-width: 100%; border-radius: 18px; border: 2px solid #F5F5F5; ">
  ...
  <vaadin-vertical-layout id="layoutDatos" style="justify-content: center; flex-grow: 1; flex-shrink: 0; border-radius: 18px; border: 2px solid #F5F5F5; background-color: white; height: 30%; align-self: center;">
   <vaadin-horizontal-layout theme="spacing" id="layoutBotonesUsuarioR" style="align-self: stretch; justify-content: flex-end; margin-right: var(--lumo-space-xs);">
    <vaadin-button id="botonEliminar" style="margin-right: var(--lumo-space-xl);">
      Eliminar 
    </vaadin-button>
   </vaadin-horizontal-layout>
...
justify-content: center; align-items: center; height: 20px; justify-content: center; font-weight: bold;">0</label>
     <label id="labelMeGustas" style="align-self: center; border-radius: 100px; border: 2px solid #F5F5F5; /* Ajusta la altura y el ancho para que sean iguales */
height: 100px; display: flex; /* Asegura que el contenido esté centrado si es necesario */
justify-content: center; align-items: center; justify-content: center; font-weight: bold; width: 50px; height: 50px; padding: 0px;">
      <iron-icon icon="vaadin:heart" id="ironIcon" style="height: 30px; width: 30px; color: black; align-self: center;"></iron-icon></label>
    </vaadin-horizontal-layout>
...
height: 100px; display: flex; /* Asegura que el contenido esté centrado si es necesario */
justify-content: center; align-items: center; justify-content: center; font-weight: bold; flex-shrink: 0; height: 50px; flex-grow: 0; width: 50px;">
